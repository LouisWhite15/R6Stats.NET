<template>
  <div class="playerData" >
    ...
    <br>
    <b-container> 
      <img style="padding:10px" :src="'https://ubisoft-avatars.akamaized.net/' + result.player.id + '/default_256_256.png'" width="150" height="150">
      <b-row class="bg-light" style="padding:10px">
        <b-col style="text-align:right">Name:<br>Level:<br>Last updated:</b-col>
      ...
      <b-row>
        <b-col>
          <!-- PLACEHOLDER IMAGE -->
          <img src="https://trackercdn.com/cdn/r6.tracker.network/ranks/svg/hd-rank17.svg" width="300" height="300">
          </b-col>
        <b-col>
